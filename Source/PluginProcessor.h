...
/**
*/
class ParrotAudioProcessor  : public juce::AudioProcessor
{
public:
    //==============================================================================
    ParrotAudioProcessor();
    ~ParrotAudioProcessor() override;
...
private:
    ...
    void updateCutFilter(ChainType & leftLowCut, CoefficientType &cutCoefficients, const Slope &lowCutSlope){
